...
void vtkPVFoamReader::initDefaultSwitches()
{
    TimeStepRange[0] = 0;
    TimeStepRange[1] = 0;
    ...
    backend_(nullptr)
{
    ...
    AreaFieldSelection = vtkDataArraySelection::New();
    ...
    AreaFieldSelection->AddObserver
    (
        vtkCommand::ModifiedEvent,
        this->SelectionObserver
    );
...
vtkPVFoamReader::~vtkPVFoamReader()
{
    ...
    AreaFieldSelection->RemoveAllObservers();
...
// ----------------------------------------------------------------------
// Area fields selection list control

vtkDataArraySelection* vtkPVFoamReader::GetAreaFieldSelection()
{
    return AreaFieldSelection;
}

int vtkPVFoamReader::GetNumberOfAreaFieldArrays()
{
    return AreaFieldSelection->GetNumberOfArrays();
}

const char* vtkPVFoamReader::GetAreaFieldArrayName(int index)
{
    return AreaFieldSelection->GetArrayName(index);
}

int vtkPVFoamReader::GetAreaFieldArrayStatus(const char* name)
{
    return AreaFieldSelection->ArrayIsEnabled(name);
}

void vtkPVFoamReader::SetAreaFieldArrayStatus(const char* name, int status)
{
    if (status)
    {
        AreaFieldSelection->EnableArray(name);
    }
    else
    {
        AreaFieldSelection->DisableArray(name);
    }
}
