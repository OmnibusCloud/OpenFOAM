    ...
    pointColour_(nullptr)
{
    ...
    pointColour_ = Function1<vector>::NewIfPresent("pointColour", dict);
    if (!pointColour_)
    {
...
)
{
    ...
    auto* ctorPtr = dictionaryConstructorTable(pointDataType);
    ...
    return autoPtr<pointData>(ctorPtr(parent, dict, colours));
}
